 ...
 * 
 * Exposes adversarial agent tools to MCP clients (Roo Code, Cursor, Claude Desktop, etc.)
 */
...
export class MCPServer {
  ...
  /**
   * Execute a task with adversarial agents
   */
