...
const DEFAULT_CONFIG: CLIConfig = {
  serverUrl: process.env.TENSIONAI_SERVER_URL || "http://localhost:3000",
  apiKey: process.env.TENSIONAI_API_KEY,
  format: "table",
};
...
Usage: tensionai <command> [options]
...
Examples:
  tensionai execute "Build a REST API"
  tensionai execute "Build a task manager" --quality=deep --sprints=5
  tensionai status task-1234567890
  tensionai list running
  tensionai switch-provider openai gpt-4o
`);
}
