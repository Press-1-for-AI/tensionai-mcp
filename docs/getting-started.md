...
| Tool | Description |
|------|-------------|
| `tensionai_execute` | Execute a task with TensionAI agents |
| `tensionai_status` | Get task status |
| `tensionai_abort` | Abort a running task |
| `tensionai_list_tasks` | List all tasks |
