...
```
Use the tensionai_execute tool to build a REST API.
```
...
5. **Use abort when needed**: Call `tensionai_abort` if a task is taking too long or appears stuck
