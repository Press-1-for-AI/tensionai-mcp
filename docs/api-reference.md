...
```json
{
  ...
  "version": "1.0.0",
  "mcpTools": ["tensionai_execute", "tensionai_status", ...],
  "capabilities": ["tensionai_execution", "multi_provider_support", ...],
...
Execute a task using the TensionAI multi-agent system.
